describe('Visitor can see list of series', () => {
  ...
  it('successfully display list of series', () => {
    cy.get('[data-cy=series-container]').within(() => {
      ...
      cy.get('data-cy=serie-link').should('have.attr', 'href', 'https://i-viaplay-com.akamaized.net/viaplay-prod/990/580/1601988235-2e6920a94b2b30019f47c286074c93ecdc0407d0.jpg?width=199&height=298&template=abcstudios')
    });
  });
});
